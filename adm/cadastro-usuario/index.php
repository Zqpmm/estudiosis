...
<div id="content" class="app-content" role="main">
    ...
    <div class="bg lter b-b wrapper-md" style="background-color: #F8F7F7; height: 80px; box-shadow: 0px 1px 5px grey; color: #323030;">
        ...
        <a href="<?php echo BASEURL; ?>adm/#<?php echo $_SESSION['id_usuarios']; ?>" style="color: black; text-decoration: none;">
            <h3 style="font-weight: 300;"><i class="fas fa-arrow-left"></i> Usuários Cadastrados</h3>
        </a>
    </div>
    ...
    <div class="center" style="margin-top: -35px;">
                    ...
                    <div class="st_wrap_table" data-table_id="0">
                        <header class="st_table_header">
                            <div class="st_row">
                                ...
                                <div class="st_column _year">Cargo</div>
                            </div>
                        </header>
                        <?php if ($exec->num_rows == 0) { ?>
                            ...
                            foreach ($exec as $result) { ?>
                                <div class="st_row">
                                    <div class="st_column _rank"><?php echo $result['nome']; ?></div>
                                    <div class="st_column _name"><?php echo $result['email']; ?></div>
                                    <div class="st_column _year"><?php echo $result['cargo']; ?></div>
                                </div>
                        <?php }
                        } ?>
                    </div>
        ...
        <div class="adicionar-posicionamento">
            <a href="<?php echo BASEURL; ?>adm/cadastro-usuario/cadastro#<?php echo $_SESSION['id_usuarios']; ?>" class="btn m-b-xs btn-addon pull-right btn-lg adicionar w3-animate-opacity"><i class="fa fa-plus"></i> Adicionar</a>
        </div>
    </div>
</div>
